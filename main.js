...
var AUTH_ROUTES = [
  {
    path: "login",
    loadComponent: () => import("./chunk-Z4OWP5CM.js").then((c) => c.LoginComponent)
  },
  {
    path: "setup-account",
    loadComponent: () => import("./chunk-47QIAQXH.js").then((c) => c.SetupAccountComponent)
  },
  {
    path: "**",
    redirectTo: "login"
...
var PAGES_ROUTES = [
  {
    path: "user-type",
    loadComponent: () => import("./chunk-CQNAMV4M.js").then((c) => c.ProfileSelectionComponent)
  },
  {
    path: "ride-selection",
    loadComponent: () => import("./chunk-YLU4FJAM.js").then((c) => c.RideSelectionComponent)
  },
  {
    path: "ride-track",
    loadComponent: () => import("./chunk-5Z2P2A7W.js").then((c) => c.RideTrackComponent)
  },
  {
    path: "ride-rating",
    loadComponent: () => import("./chunk-QHVE67V5.js").then((c) => c.RideRatingComponent)
  },
  {
    path: "ride-transactions",
    loadComponent: () => import("./chunk-667M23K6.js").then((c) => c.RideTransactionsComponent)
  }
];
...
var _AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const moduleImpl = this.moduleImpl ?? import("./chunk-IXZLM6W3.js");
